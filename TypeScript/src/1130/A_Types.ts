...
//  : 타입을 지정할 때
//  : 원소의 타입을 순서대로 작성
const nameAndHeight: [string, number] = ['공세동', 175];
//  let Tuple: [number,string,number] = [1, 2, '3'];  //  순서대로 작성안해서 Error
...
//  : null 과 undefined에 자기 자산의 타입 그리고 void 타입 외의 타입에 할당하는 경우 에러 발생
...
//  --strictNullChecks 컴파일 옵션으로 인하여 null과 undefined가 각각 해당 이름의 타ㅓ입을 가진 변수에만 할당 가능
...
//  : TS 컴파일러가 noImplicitAny를 활성화 하는 경우
