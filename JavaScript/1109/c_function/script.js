...
// : ES6에서 도입된 함수 정의 방식
// : 기존의 function 키워드를 화살표로 대체하여, 간견한 함수를 작서
// : 항상 익명함수로 사용
...
// : 함수 호출시 괄호 안에 인수(arguments)를 넣어서 전달
// : 해당 신수는 함수 내부로 전달되어 매개변수(parameters)라는
// : 이름으로 사용
...
// 함수호출
hello('SaeDong'); // 'SaeDong'는 인수

//! 6. 자바스크립트의 파라미터와 인수 사용
// : 함수 호출 시 전달되는 인수의 수와
// : 함수 정의시 선언된 파라미터의 수가 일치하지 않아도 가능
...
// subtract 함수의 바환값 (3 - 5 = -2)이 subtractResult 변수에 저장
