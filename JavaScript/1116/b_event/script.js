...
//  이벤트 객체 실습
//  : 16개의 타일 세트
//  : querySelectorAll()을 사용하여 16개의 타일의 참조를 div상수 할당
//  : 반복문을 사용하여 16개의 타일에 이벤트 핸들러를 등록
//  : 각각의 타일을 클릭했을때 클릭된 타일의 배경색이 변경되도록 지정
function random(number) {
  return Math.floor(Math.random() * (number + 1));
}
...
//! 3. 이벤트 버블링과 캡쳐
//  : 같은 이벤트 타입의 두 이벤트 핸들러가 한요소에서 작동될 때 어떠한 일이 일어나는지를 기술하는 방법
...
//  이벤트 전파를 중지
//  : event.stopImmediatePropagation 메서드
