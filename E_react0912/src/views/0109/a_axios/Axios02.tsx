...
export default function Axios02() {
  ...
  return (
    <div>
      <input type="text" value={newUser.username} name="username" onChange={handleInputChange} />
      <input type="text" value={newUser.email} name="email" onChange={handleInputChange} />
