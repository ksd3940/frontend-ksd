...
const handleSubmit = () => {
  ...
  return (
    <>
      <input type="text" placeholder="이름을 입력하세요." onChange={handleInputChange} name="name" value={name} />
      <input type="text" placeholder="나이를 입력하세요." onChange={handleInputChange} name="age" value={age} />
