...
const person = {name: 'ksd', age: 30, height:175, gender:'male'}
...
// 배열을 할당하여 복사하는 겨웅 주소값이 복사되기 때문에
// 복사된 배열을 수정하면 기본 배열 또한 똑같이 수정
